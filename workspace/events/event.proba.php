...
class eventproba extends SectionEvent
{
    public $ROOTELEMENT = 'proba';
    ...
    public static function about()
    {
        return array(
            ...
            'release-date' => '2016-12-22T11:20:14+00:00',
            'trigger-condition' => 'action[proba]'
        );
    }
    ...
    public static function documentation()
    {
        return '
                ...
                <pre class="XML"><code>&lt;proba result="success" type="create | edit">
    &lt;message>Entry [created | edited] successfully.&lt;/message>
&lt;/proba></code></pre>
                <p>When an error occurs during saving, due to either missing or invalid fields, the following XML will be returned.</p>
                <pre class="XML"><code>&lt;proba result="error">
...
...&lt;/proba></code></pre>
    ...
    &lt;/label>
    &lt;input name="action[proba]" type="submit" value="Submit" />
&lt;/form></code></pre>
