                    ...
                    <div class="row features-item section-separator">
                        ...
                        <xsl:call-template name="learnfilesubheader"/>  
		                    ...
		                    <div class="col-xs-12 each-features">
		                        ...
		                        <div class="box-border-text-left" style="width: 45%;">
		                        ...
		                        <div class="box-border-text-left" style="width: 45%; overflow-y: scroll; height: 380px;">
		                        ...
		                        <div class="box-border-text-left" style="width: 60%; overflow-y: scroll; height: 380px;">
		                            <h3 class="title"> RECENT ACTIVITY<br/>IN YOUR NETWORK</h3><br/>
		                            <div class="box-poligon" style="width: 100%; ">
		                                <div class="box-poligon" style="width: 20%; ">
		                                    <img src="assets/images/guide-team/icon-8.png" />
		                                </div>
		                            ...
		                            <div class="box-poligon" style="width: 100%; ">
		                                <div class="box-poligon" style="width: 20%; ">
		                                    <img src="assets/images/guide-team/icon-7.png" />
		                                </div>
		                                <div class="box-poligon" style="width: 75%;">
		                                    <p class="pera">James published his tory: Leading JCI in one of the smallest countries in the world.</p>
		                                </div>
		                            ...
		                            <div class="box-poligon" style="width: 100%; ">
		                                <div class="box-poligon" style="width: 20%; ">
		                                    <img src="assets/images/guide-team/icon-1.png" />
		                                </div>
		                                <div class="box-poligon" style="width: 75%;">
		                                    <p class="pera">James published his tory: Leading JCI in one of the smallest countries in the world.</p>
		                                </div>
		                        ...
		                        <div class="box-border-text-left" style="width: 30%; overflow-y: scroll; height: 380px;">
		                    ...
		                    <div class="col-xs-12 each-features" style=" height: 1000px;">
		                        <div class="box-border" style=" width: 45%; height: 100%; border: 0px;">
